...
use Forminator\PayPal\Core\PayPalConfigManager;
...
class ApiContext
{
     ...
     * If the value is not set, it would get the value from @\Forminator\PayPal\Core\PayPalCredentialManager
     *
     * @var \Forminator\PayPal\Auth\OAuthTokenCredential
     */
    private $credential;
     ...
     * Construct
     *
     * @param \Forminator\PayPal\Auth\OAuthTokenCredential $credential
     ...
     * Get Credential
     *
     * @return \Forminator\PayPal\Auth\OAuthTokenCredential
     */
