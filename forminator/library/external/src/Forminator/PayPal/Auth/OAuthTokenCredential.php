...
namespace Forminator\PayPal\Auth;

use Forminator\PayPal\Cache\AuthorizationCache;
use Forminator\PayPal\Common\PayPalResourceModel;
use Forminator\PayPal\Core\PayPalHttpConfig;
use Forminator\PayPal\Core\PayPalHttpConnection;
use Forminator\PayPal\Core\PayPalLoggingManager;
use Forminator\PayPal\Exception\PayPalConfigurationException;
use Forminator\PayPal\Exception\PayPalConnectionException;
use Forminator\PayPal\Handler\IPayPalHandler;
use Forminator\PayPal\Rest\ApiContext;
use Forminator\PayPal\Security\Cipher;
...
class OAuthTokenCredential extends PayPalResourceModel
{
     ...
     */
    public static $AUTH_HANDLER = 'Forminator\PayPal\Handler\OauthHandler';
     ...
     * @throws \Forminator\PayPal\Exception\PayPalConnectionException
     */
