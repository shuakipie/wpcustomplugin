...
namespace Forminator\PayPal\Common;

use Forminator\PayPal\Rest\ApiContext;
use Forminator\PayPal\Rest\IResource;
 ...
 * @package Forminator\PayPal\Common
 */
class PayPalResourceModel extends PayPalModel implements IResource
{
     ...
     */
    protected static function executeCall($url, $method, $payLoad, $headers = array(), $apiContext = null, $restCall = null, $handlers = array('Forminator\PayPal\Handler\RestHandler'))
    {
