...
namespace Forminator\PayPal\Handler;

use Forminator\PayPal\Auth\OAuthTokenCredential;
use Forminator\PayPal\Common\PayPalUserAgent;
use Forminator\PayPal\Core\PayPalConstants;
use Forminator\PayPal\Core\PayPalCredentialManager;
use Forminator\PayPal\Core\PayPalHttpConfig;
use Forminator\PayPal\Exception\PayPalConfigurationException;
use Forminator\PayPal\Exception\PayPalInvalidCredentialException;
use Forminator\PayPal\Exception\PayPalMissingCredentialException;
...
class RestHandler implements IPayPalHandler
{
     ...
     *
     * @return string
     * @throws \Forminator\PayPal\Exception\PayPalConfigurationException
     */
