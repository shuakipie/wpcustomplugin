 ...
 * @property \Forminator\PayPal\Api\InstallmentOption[] installment_options
 */
class InstallmentInfo extends PayPalModel
{
     ...
     *
     * @param \Forminator\PayPal\Api\InstallmentOption[] $installment_options
     *
     * @return $this
     */
     ...
     * List of available installment options and the cost associated with each one.
     *
     * @return \Forminator\PayPal\Api\InstallmentOption[]
     */
     ...
     *
     * @param \Forminator\PayPal\Api\InstallmentOption $installmentOption
     * @return $this
     */
