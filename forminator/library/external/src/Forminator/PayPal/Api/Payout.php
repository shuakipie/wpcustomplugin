 ...
 * @property \Forminator\PayPal\Api\PayoutItem[] items
...
class Payout extends PayPalResourceModel
{
     ...
     *
     * @param \Forminator\PayPal\Api\PayoutItem[] $items
     *
     * @return $this
     */
     ...
     * An array of payout items (that is, a set of individual payouts).
     *
     * @return \Forminator\PayPal\Api\PayoutItem[]
     */
     ...
     *
     * @param \Forminator\PayPal\Api\PayoutItem $payoutItem
     * @return $this
     */
