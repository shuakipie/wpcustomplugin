 ...
 * @property \Forminator\PayPal\Api\Invoice[] invoices
 */
class InvoiceSearchResponse extends PayPalModel
{
     ...
     *
     * @param \Forminator\PayPal\Api\Invoice[] $invoices
     *
     * @return $this
     */
     ...
     * List of invoices belonging to a merchant.
     *
     * @return \Forminator\PayPal\Api\Invoice[]
     */
     ...
     *
     * @param \Forminator\PayPal\Api\Invoice $invoice
     * @return $this
     */
