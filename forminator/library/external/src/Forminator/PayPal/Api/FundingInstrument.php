 ...
 *
 * @property \Forminator\PayPal\Api\CreditCard credit_card
 * @property \Forminator\PayPal\Api\CreditCardToken credit_card_token
 * @property \Forminator\PayPal\Api\Billing billing
 */
class FundingInstrument extends PayPalModel
{
     ...
     *
     * @param \Forminator\PayPal\Api\CreditCard $credit_card
     *
     * @return $this
     */
     ...
     *
     * @param \Forminator\PayPal\Api\CreditCardToken $credit_card_token
     *
     * @return $this
     */
     ...
     * PayPal vaulted credit Card instrument.
     *
     * @return \Forminator\PayPal\Api\CreditCardToken
     */
     ...
     *
     * @param \Forminator\PayPal\Api\PaymentCard $payment_card
     *
     * @return $this
     */
     ...
     * Payment Card information.
     *
     * @return \Forminator\PayPal\Api\PaymentCard
     */
     ...
     * @param \Forminator\PayPal\Api\ExtendedBankAccount $bank_account
     *
     * @return $this
     */
     ...
     * Bank Account information.
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\ExtendedBankAccount
     */
     ...
     * @deprecated Not publicly available
     * @param \Forminator\PayPal\Api\BankToken $bank_account_token
     *
     * @return $this
     */
     ...
     * Vaulted bank account instrument.
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\BankToken
     */
     ...
     * @deprecated Not publicly available
     * @param \Forminator\PayPal\Api\Credit $credit
     *
     * @return $this
     */
     ...
     * PayPal credit funding instrument.
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\Credit
     */
     ...
     * @deprecated Not publicly available
     * @param \Forminator\PayPal\Api\Incentive $incentive
     *
     * @return $this
     */
     ...
     * Incentive funding instrument.
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\Incentive
     */
     ...
     * @deprecated Not publicly available
     * @param \Forminator\PayPal\Api\CarrierAccountToken $carrier_account_token
     *
     * @return $this
     */
     ...
     * Carrier account token instrument.
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\CarrierAccountToken
     */
     ...
     * @deprecated Not publicly available
     * @param \Forminator\PayPal\Api\CarrierAccount $carrier_account
     *
     * @return $this
     */
     ...
     * Carrier account instrument
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\CarrierAccount
     */
     ...
     * @deprecated Not publicly available
     * @param \Forminator\PayPal\Api\PrivateLabelCard $private_label_card
     *
     * @return $this
     */
     ...
     * Private Label Card funding instrument. These are store cards provided by merchants to drive business with value to customer with convenience and rewards.
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\PrivateLabelCard
     */
     ...
     *
     * @param \Forminator\PayPal\Api\Billing $billing
     *
     * @return $this
     */
     ...
     * Billing instrument that references pre-approval information for the payment
     *
     * @return \Forminator\PayPal\Api\Billing
     */
     ...
     *
     * @deprecated Not publicly available
     * @param \Forminator\PayPal\Api\AlternatePayment $alternate_payment
     *
     * @return $this
     */
     ...
     *
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\AlternatePayment
     */
