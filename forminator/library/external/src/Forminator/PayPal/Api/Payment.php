 ...
 * @property \Forminator\PayPal\Api\Transaction[] transactions
 * @property string state
 * @property string experience_profile_id
 * @property string note_to_payer
 * @property \Forminator\PayPal\Api\Payee $payee
 * @property \Forminator\PayPal\Api\RedirectUrls redirect_urls
...
class Payment extends PayPalResourceModel
{
     ...
     * @param \Forminator\PayPal\Api\PotentialPayerInfo $potential_payer_info
     *
     * @return $this
     */
     ...
     * Information that the merchant knows about the payer.  This information is not definitive and only serves as a hint to the UI or any pre-processing logic.
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\PotentialPayerInfo
     */
     ...
     *
     * @param \Forminator\PayPal\Api\Transaction[] $transactions
     *
     * @return $this
     */
     ...
     * Transactional details including the amount and item details.
     *
     * @return \Forminator\PayPal\Api\Transaction[]
     */
     ...
     *
     * @param \Forminator\PayPal\Api\Transaction $transaction
     * @return $this
     */
     ...
     * @deprecated Not publicly available
     * @param \Forminator\PayPal\Api\Error[] $failed_transactions
     *
     * @return $this
     */
     ...
     * Applicable for advanced payments like multi seller payment (MSP) to support partial failures
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\Error[]
     */
     ...
     * @deprecated Not publicly available
     * @param \Forminator\PayPal\Api\Error $error
     * @return $this
     */
     ...
     * @deprecated Not publicly available
     * @param \Forminator\PayPal\Api\CreditFinancingOffered $credit_financing_offered
     *
     * @return $this
     */
     ...
     * Credit financing offered to payer on PayPal side. Returned in payment after payer opts-in
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\CreditFinancingOffered
     */
     ...
     * @deprecated Not publicly available
     * @param \Forminator\PayPal\Api\PaymentInstruction $payment_instruction
     *
     * @return $this
     */
     ...
     * Instructions for the payer to complete this payment.
     * @deprecated Not publicly available
     * @return \Forminator\PayPal\Api\PaymentInstruction
     */
     ...
     *
     * @param \Forminator\PayPal\Api\RedirectUrls $redirect_urls
     *
     * @return $this
     */
     ...
     * Set of redirect URLs you provide only for PayPal-based payments.
     *
     * @return \Forminator\PayPal\Api\RedirectUrls
     */
