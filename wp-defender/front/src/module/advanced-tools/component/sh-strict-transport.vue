<template>
	<div class="sui-toggle-content">
		<div class="sui-border-frame">
			...
			<div class="toggle-content-header">{{__("Browser Caching")}}</div>
	...
	export default {
		...
		data: function () {
			return {
				...
				hsts_preload: this.misc.hsts_preload,
				allow_subdomain: this.misc.allow_subdomain,
				include_subdomain: this.misc.include_subdomain,
				hsts_cache_duration: this.misc.hsts_cache_duration,
				model: this.model
			}
		},
		created: function () {
