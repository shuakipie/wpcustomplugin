			...
			<div class="sui-box-body">
					...
					<div class="sui-box-settings-col-2">
						<div class="sui-form-field">
							<label class="sui-toggle">
								<input role="presentation" type="checkbox" name="sh_xframe" class="toggle-checkbox"
									   id="sh_xframe" v-model="model.sh_xframe" :true-value="true"
									   :false-value="false"/>
								<span class="sui-toggle-slider"></span>
							</label>
							<label for="sh_xframe" class="sui-toggle-label">
								{{__("Enable ")}}{{misc.sh_xframe.title}}
							</label>
							<sh-xframe
				...
				<div class="sui-box-settings-row">
					...
					<div class="sui-box-settings-col-2">
						<div class="sui-form-field">
							<label class="sui-toggle">
								<input role="presentation" type="checkbox" name="sh_xss_protection" class="toggle-checkbox"
									id="sh_xss_protection" v-model="model.sh_xss_protection" :true-value="true"
									:false-value="false"/>
								<span class="sui-toggle-slider"></span>
							</label>
							<label for="sh_xss_protection" class="sui-toggle-label">
								{{__("Enable ")}}{{misc.sh_xss_protection.title}}
							</label>
							<sh-xss-protection
				...
				<div class="sui-box-settings-row">
					...
					<div class="sui-box-settings-col-2">
						<div class="sui-form-field">
							<label class="sui-toggle">
								<input role="presentation" type="checkbox" name="sh_content_type_options" class="toggle-checkbox"
									   id="sh_content_type_options" v-model="model.sh_content_type_options" :true-value="true"
									   :false-value="false"/>
								<span class="sui-toggle-slider"></span>
							</label>
							<label for="sh_content_type_options" class="sui-toggle-label">
								{{__("Enable ")}}{{misc.sh_content_type_options.title}}
							</label>
				...
				<div class="sui-box-settings-row">
					...
					<div class="sui-box-settings-col-2">
						<div class="sui-form-field">
							<label class="sui-toggle">
								<input role="presentation" type="checkbox" name="sh_strict_transport" class="toggle-checkbox"
									   id="sh_strict_transport" v-model="model.sh_strict_transport" :true-value="true"
									   :false-value="false"/>
								<span class="sui-toggle-slider"></span>
							</label>
							<label for="sh_strict_transport" class="sui-toggle-label">
								{{__("Enable ")}}{{misc.sh_strict_transport.title}}
							</label>
							<sh-strict-transport
				...
				<div class="sui-box-settings-row">
					...
					<div class="sui-box-settings-col-2">
						<div class="sui-form-field">
							<label class="sui-toggle">
								<input role="presentation" type="checkbox" name="sh_referrer_policy" class="toggle-checkbox"
									   id="sh_referrer_policy" v-model="model.sh_referrer_policy" :true-value="true"
									   :false-value="false"/>
								<span class="sui-toggle-slider"></span>
							</label>
							<label for="sh_referrer_policy" class="sui-toggle-label">
								{{__("Enable ")}}{{misc.sh_referrer_policy.title}}
							</label>
							<sh-referrer-policy
				...
				<div class="sui-box-settings-row">
					...
					<div class="sui-box-settings-col-2">
						<div class="sui-form-field">
							<label class="sui-toggle">
								<input role="presentation" type="checkbox" name="sh_feature_policy" class="toggle-checkbox"
									   id="sh_feature_policy" v-model="model.sh_feature_policy" :true-value="true"
									   :false-value="false"/>
								<span class="sui-toggle-slider"></span>
							</label>
							<label for="sh_feature_policy" class="sui-toggle-label">
								{{__("Enable ")}}{{misc.sh_feature_policy.title}}
							</label>
							<sh-feature-policy
