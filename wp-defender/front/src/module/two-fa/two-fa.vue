                ...
                <div class="sui-summary-segment">
                    <ul class="sui-list">
                        ...
                        <li id="customgraphic-tag">
                            ...
                            <span class="sui-list-detail">
							    <span v-if="state.old_graphic_value === false"
                                      class="sui-tag sui-tag-disabled sui-tag-sm">{{__("Disabled")}}</span>
                                <span v-else-if="state.old_graphic_value === true"
                                      class="sui-tag sui-tag-blue sui-tag-sm">{{__("Active")}}</span>
						    </span>
                        </li>
                ...
                <form method="post" id="advanced-settings-frm" @submit.prevent="updateSettings">
                    <div class="sui-box-body">
                        ...
                        <div class="sui-box-settings-row">
                            ...
                            <div class="sui-box-settings-col-2">
                                <label class="sui-toggle">
                                    <input role="presentation" type="checkbox" name="custom_graphic"
                                           class="toggle-checkbox"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            updateSettings: function () {
                ...
                this.httpPostRequest('updateSettings', {
                    ...
                    self.state.old_graphic_value = self.model.custom_graphic;
        ...
        beforeMount() {
            this.state.old_graphic_value = this.model.custom_graphic;
