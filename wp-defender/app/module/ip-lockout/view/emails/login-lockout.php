                                            ...
                                            <tr style="padding: 0; text-align: left; vertical-align: top;">
                                                <td class="main-intro-content"
                                                    ...
                                                    <p style="Margin: 0; Margin-bottom: 0; color: #555555; font-family: Helvetica, Arial, sans-serif; font-size: 15px; font-weight: normal; line-height: 26px; margin: 0; margin-bottom: 0; padding: 0 0 24px; text-align: left;">
														<?php
														$lockout_duration = $setting->login_protection_lockout_ban == true ? __( "They have been banned permanently.", wp_defender()->domain ) : sprintf( __( "They have been locked out for <strong>%s %s.</strong>", wp_defender()->domain ), $setting->login_protection_lockout_duration, $setting->login_protection_lockout_duration_unit );
