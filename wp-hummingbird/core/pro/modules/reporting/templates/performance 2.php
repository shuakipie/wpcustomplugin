									...
									<tr class="report-list-item" style="padding: 0;text-align: left;vertical-align: top">
										...
										<?php if ( 'both' === $params['DEVICE'] || 'desktop' === $params['DEVICE'] ) : ?>
											<td class="report-list-item-info" style="border-collapse: collapse !important;color: #888888;font-family: Arial, sans-serif;font-size: 13px;font-weight: normal;line-height: 22px;margin: 0;padding: 10px 0;text-align: right;vertical-align: top">
												...
												<img src="<?php echo esc_url( WPHB_DIR_URL . 'core/pro/modules/reporting/templates/images/icon-' . \Hummingbird\Core\Modules\Performance::get_impact_class( $metric->score * 100 ) . '.png' ); ?>" alt="<?php echo esc_attr( \Hummingbird\Core\Modules\Performance::get_impact_class( $metric->score ) ); ?>" style="-ms-interpolation-mode: bicubic; border: none; clear: both; float: right; display: inline-block; margin: 2px 0 0 10px; height: 16px; outline: none; text-decoration: none; width: auto; vertical-align: middle;">
											</td>
										<?php endif; ?>
										<?php if ( 'both' === $params['DEVICE'] || 'mobile' === $params['DEVICE'] ) : ?>
											<td class="report-list-item-result ok" style="border-collapse: collapse !important;color: #888888;font-family: Arial, sans-serif;font-size: 13px;font-weight: normal;line-height: 22px;margin: 0;min-width: 65px;padding: 10px 0;text-align: right;vertical-align: top">
												...
												<img src="<?php echo esc_url( WPHB_DIR_URL . 'core/pro/modules/reporting/templates/images/icon-' . \Hummingbird\Core\Modules\Performance::get_impact_class( $last_test->mobile->metrics->{$index}->score * 100 ) . '.png' ); ?>" alt="<?php echo esc_attr( \Hummingbird\Core\Modules\Performance::get_impact_class( $last_test->mobile->metrics->{$index}->score ) ); ?>" style="-ms-interpolation-mode: bicubic; border: none; clear: both; float: right; display: inline-block; margin: 2px 0 0 10px; height: 16px; outline: none; text-decoration: none; width: auto; vertical-align: middle;">
											</td>
										<?php endif; ?>
									</tr>
								<?php endforeach; ?>
							...
							<table class="reports-list" align="center" style="border-collapse: collapse;border-spacing: 0;margin: 0 0 30px;padding: 0;text-align: left;vertical-align: top;width: 100%">
								...
								<tr class="report-list-item" style="padding: 0;text-align: left;vertical-align: top">
									...
									<?php if ( 'both' === $params['DEVICE'] || 'desktop' === $params['DEVICE'] ) : ?>
										<td class="report-list-item-info" style="border-collapse: collapse !important;color: #ffffff;font-family: Arial, sans-serif;font-size: 12px;font-weight: normal;line-height: 27px;margin: 0;padding: 10px 0;text-align: right;vertical-align: top">
											<?php
											$class = \Hummingbird\Core\Modules\Performance::get_audits_class( $last_test->desktop->audits->opportunities );
											$color = '#1ABC9C';
											if ( 'error' === $class ) {
												$color = '#FF6D6D';
									...
									<?php if ( 'both' === $params['DEVICE'] || 'mobile' === $params['DEVICE'] ) : ?>
										<td class="report-list-item-info" style="border-collapse: collapse !important;color: #ffffff;font-family: Arial, sans-serif;font-size: 12px;font-weight: normal;line-height: 27px;margin: 0;padding: 10px 0;text-align: right;vertical-align: top">
											<?php
											$class = \Hummingbird\Core\Modules\Performance::get_audits_class( $last_test->mobile->audits->opportunities );
											$color = '#1ABC9C';
											if ( 'error' === $class ) {
												$color = '#FF6D6D';
											} elseif ( 'warning' === $class ) {
								...
								<tr class="report-list-item" style="padding: 0;text-align: left;vertical-align: top">
									...
									<?php if ( 'both' === $params['DEVICE'] || 'desktop' === $params['DEVICE'] ) : ?>
										<td class="report-list-item-info" style="border-collapse: collapse !important;color: #ffffff;font-family: Arial, sans-serif;font-size: 12px;font-weight: normal;line-height: 27px;margin: 0;padding: 10px 0;text-align: right;vertical-align: top">
											<?php
											$class = \Hummingbird\Core\Modules\Performance::get_audits_class( $last_test->desktop->audits->diagnostics );
											$color = '#1ABC9C';
											if ( 'error' === $class ) {
												$color = '#FF6D6D';
											} elseif ( 'warning' === $class ) {
									...
									<?php if ( 'both' === $params['DEVICE'] || 'mobile' === $params['DEVICE'] ) : ?>
										<td class="report-list-item-info" style="border-collapse: collapse !important;color: #ffffff;font-family: Arial, sans-serif;font-size: 12px;font-weight: normal;line-height: 27px;margin: 0;padding: 10px 0;text-align: right;vertical-align: top">
											<?php
											$class = \Hummingbird\Core\Modules\Performance::get_audits_class( $last_test->mobile->audits->diagnostics );
											$color = '#1ABC9C';
											if ( 'error' === $class ) {
												$color = '#FF6D6D';
											} elseif ( 'warning' === $class ) {
