	...
	<div class="sui-box-settings-row">
		...
		<div class="sui-box-settings-col-2">
			...
			<div class="sui-border-frame sui-toggle-content schedule-box <?php echo $reports_settings['enabled'] ? '' : 'sui-hidden'; ?>">
				...
				<a class="sui-button sui-button-ghost sui-add-recipient" data-modal-open="wphb-add-recipient-modal" data-modal-open-focus="wp-smush-select-dir" data-modal-mask="true">
				...
				<?php if ( $pending && count( $reports_settings['recipients'] ) ) : ?>
					<div class="sui-notice" id="wphb-pending-sub-notice">
