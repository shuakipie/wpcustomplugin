...
<a id="wphb-upgrade-membership-modal-link" class="sui-button sui-button-green" href="<?php echo esc_url( \Hummingbird\Core\Utils::get_link( 'plugin', 'hummingbird_uptime_upgrade_button' ) ); ?>" target="_blank">
