		...
		<?php if ( ! is_multisite() ) : ?>
			...
			<?php else : ?>
				<li>
					<span class="sui-list-label"><?php esc_html_e( 'WPMU DEV CDN', 'wphb' ); ?></span>
					<span class="sui-list-detail">
						<span class="sui-tag sui-tag-upsell sui-tooltip sui-tooltip-top-right" data-tooltip="<?php esc_html_e( 'Host your files on WPMU DEV’s blazing fast CDN', 'wphb' ); ?>" data-modal-open="wphb-upgrade-membership-modal" data-modal-open-focus="upgrade-to-pro-button" data-modal-mask="true" id="dash-uptime-update-membership">
