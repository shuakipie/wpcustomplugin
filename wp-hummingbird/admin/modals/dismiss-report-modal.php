	...
	<div role="dialog" class="sui-modal-content" id="dismiss-report-modal" aria-modal="true" aria-labelledby="dismissReport" aria-describedby="dialogDescription">
		<div class="sui-box">
			...
			<div class="sui-box-footer sui-flatten sui-content-center">
				<form method="post">
					<a class="sui-button sui-button-ghost" data-modal-close=""><?php esc_html_e( 'Cancel', 'wphb' ); ?></a>
					<button type="submit" name="dismiss_report" id="dismiss_report" class="sui-button sui-button-blue"><?php esc_html_e( 'Confirm', 'wphb' ); ?></button>
